...
- 📤 **JSON output** — machine-readable schema (`tscope/report/v7`) for scripting
...
| `--json` | _(none)_ | Emit the report as JSON (`tscope/report/v7`) to stdout instead of formatted text. | No |
...
- [JSON Output](docs/json-output.md) — `tscope/report/v7` schema reference
